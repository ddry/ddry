...
(function() {
  ...
  module.exports = {
    ...
    fallback: function(path) {
      var fallbackPrefix, prefix, unprefixed;
      unprefixed = path.replace(/\.\.\//g, '');
      prefix = path.replace(unprefixed, '');
      fallbackPrefix = this.switch(prefix);
      return `${fallbackPrefix}${unprefixed}`;
    },
    fetch: function(args) {
    ...
    fetchModular: function(config) {
      ...
      return this.fetchModule(config.cli.ddry) || 'ddry/modular';
    },
    fetchModule: function(path) {
      ...
      try {
        ...
        e = error;
        fallbackPath = this.fallback(path);
        try {
    ...
    serveSpec: function(constraints, preventLoop = false) {
    ...
    switch: function(prefix) {
      var another;
      another = {
        '../../': '../../../../',
        '../../../../': '../../'
      };
      return another[prefix] || prefix;
    }
  };
